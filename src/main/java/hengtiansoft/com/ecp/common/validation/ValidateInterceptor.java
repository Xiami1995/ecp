...
package hengtiansoft.com.ecp.common.validation;
...
import hengtiansoft.com.ecp.common.util.ApplicationContextUtil;
...
public class ValidateInterceptor {
    ...
    private static final String EXECUTION = "execution(* hengtiansoft.com.ecp..*.*(..,@hengtiansoft.com.ecp.common.dto.annotation.OnValid (*),..))";
